    ...
    renderRows() {
        ...
        return list.map((item, index) => (
            <tr key={index}>
                ...
                <td className='table-actions-credits'>
                    <button type='button' className='btn btn-success btn-sm' onClick={() => this.add(index + 1)} >
                        <i className='fa fa-plus'></i>
                    </button>
                    <button type='button' className='btn btn-warning btn-sm' onClick={() => this.add(index + 1, item)} >
                        <i className='fa fa-clone'></i>
                    </button>
                    <button type='button' className='btn btn-danger btn-sm' onClick={() => this.remove(index)} >
